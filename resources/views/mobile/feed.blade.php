...
<div id="tiktok-feed" class="h-screen w-full overflow-y-scroll snap-y snap-mandatory bg-slate-50 scroll-smooth relative">
    ...
    <button id="autoplay-btn" onclick="toggleAutoplay()" class="fixed top-4 right-4 z-50 bg-white/80 backdrop-blur-xl border border-slate-200 w-11 h-11 rounded-full flex items-center justify-center text-slate-700 hover:bg-[var(--color-wh-accent)] hover:text-white hover:border-[var(--color-wh-accent)] transition-all shadow-lg" title="Tự động phát">
